...
int minimax(Point step, int depth, int player)
{
    ...
    {
        return score_board[step.x][step.y];
    }
    if(player == 1)
    {
        int bestval = -1000;
...
int main(int, char** argv) {
    ...
    score_board[0] = {90, -60, 10, 10, 10, 10, -60, 90};
    score_board[1] = {-60, -80, 5, 5, 5, 5, -80, -60};
    score_board[2] = {10, 5, 1, 1, 1, 1, 5, 10};
    score_board[3] = {10, 5, 1, 1, 1, 1, 5, 10};
    score_board[4] = {10, 5, 1, 1, 1, 1, 5, 10};
    score_board[5] = {10, 5, 1, 1, 1, 1, 5, 10};
    score_board[6] = {-60, -80, 5, 5, 5, 5, -80, -60};
    score_board[7] = {90, -60, 10, 10, 10, 10, -60, 90};
    read_board(fin);
